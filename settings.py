...
# area it is in.  If there's a match, it will be annotated with the area name.
# If no match, the neighborhood field, which is a string, will be checked to
# see if it matches anything in NEIGHBORHOODS.
BOXES = {
    "adams_point": [
        [37.80789, -122.25000],
        [37.81589,  -122.26081],
...
# field. If a listing doesn't fall into one of the boxes you defined, it will be
# checked to see if the neighborhood name it was listed under matches one of
# these.  This is less accurate than the boxes, because it relies on the owner
# to set the right neighborhood, but it also catches listings that don't have
# coordinates (many listings are missing this info).
...
# For instance, https://sfbay.craigslist.org/search/apa find apartments
# for rent.
